...
void testMapMerging() {
  ...
  final merge = mergeMaps(info1, info2, value: (one, two) => two);
  print(merge);
}
...
void testCombinedListView() {
  ...
  final swedishNames = ['Magnus', 'Erik', 'Gustav'];
  final norwegianNames = ['Aksel', 'Filip', 'Ole'];
  final frenchNames = ['Louis', 'Gabriel', 'Pierre'];
